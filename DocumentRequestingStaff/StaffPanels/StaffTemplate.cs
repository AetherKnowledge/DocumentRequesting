...
{
    public partial class StaffTemplate : MaterialSkin.Controls.MaterialForm
    {
        public StaffTemplate()
        {
            ...
            SkinManager.ColorScheme = new MaterialSkin.ColorScheme(Color.FromArgb(128, 175, 129), Color.FromArgb(128, 175, 129), Color.FromArgb(212, 231, 197), Color.FromArgb(212, 231, 197), MaterialSkin.TextShade.WHITE);

        }

        public new void Show()
        {
            if (User.CurrentUser != null && User.CurrentUser.Role == UserType.Admin) adminBtnPanel.Visible = true;
            else adminBtnPanel.Visible = false;
        ...
        {
            if (Utilities.AdminPanel == null) return;

            this.Hide();
            Utilities.AdminPanel.Show();
        }
    }
}
